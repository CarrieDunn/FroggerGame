...
var Engine = (function(global) {
    ...
    function render() {
         ...
         */
        var rowImages = [
                'images/gates.png',   // Top row is water
                'images/gravestone_360.png',   // Row 1 of 3 of stone
                'images/gravestone_360.png',   // Row 2 of 3 of stone
                'images/gravestone_360.png',   // Row 3 of 3 of stone
                'images/background.png',   // Row 1 of 2 of grass
                'images/swirl.png'    // Row 2 of 2 of grass
            ],
            numRows = 6,
            numCols = 5,
            row, col;
    ...
    Resources.load([
        ...
        'images/Star.png',
        'images/ghost-512.png',
        'images/ghost_360.png',
        'images/gravestone_360.png',
        'images/pumkin1.png',
        'images/pumkin2.png',
        'images/pumkin3.png',
        'images/gates.png',
